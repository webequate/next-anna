  ...
  return (
    <div className="mx-auto">
      ...
      <div className="text-secondary-dark dark:text-secondary-light">
        <h1 className="text-xl font-bold tracking-tight text-primary-dark dark:text-primary-light sm:text-3xl mb-6">About</h1>
        <p className="text-base mt-4 mb-4">{ name }</p>
        <p className="text-base mt-4 mb-4">{ title }</p>
        { abouts.map((about, index) => (
          <p key={index} className="text-base mt-4 mb-4">{ about }</p>
        ))}
        <DownloadCV resumelink={ resumeLink } />
        <p className="text-base mt-4 mb-4">{ website }</p>
        <p className="text-base mt-4 mb-4">{ location }</p>
        <p className="text-base mt-4 mb-4">{ phone }</p>
